  ...
  return (
    <div className="row justify-content-center h-75">
      ...
      <div className="col-sm-8 col-md-6 col-lg-4">
        <Carousel>
          <Carousel.Item>
            <img className="d-block w-100" src={Parul} alt="First slide" />
            <Carousel.Caption>
              <h3 className="names">Parul Raj</h3>
              <p className="aboutText">Favorite Game: Card-Matching</p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src={Megan} alt="Second slide" />
            <Carousel.Caption>
              <h3 className="names">Megan McLean</h3>
              <p className="aboutText">Favorite Game: Wordle</p>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img className="d-block w-100" src={Isaac} alt="Third slide" />
            <Carousel.Caption>
          ...
          <Carousel.Item>
            <img className="d-block w-100" src={Sab} alt="Fourth slide" />
            <Carousel.Caption>
